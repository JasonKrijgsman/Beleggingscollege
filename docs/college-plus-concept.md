...
- **De coach als "bibliothecaris"/vraagbaak als hoofdrol.** Het coach-concept zegt het zelf eerlijk: op ~100 minuten corpus is een vraagbaak in twee sessies uitgevraagd. De vraagbaak-functie komt er (fase 2), maar draagt niets.
...
9. **Cursus 4 (Beleggingspsychologie, incl. biastest) af.** Niet als retentiegrond maar als prijsrekensom: €149 moet zichtbaar meer bevatten dan twee losse cursussen van €98. Schrijven begint pas als de groeipoort (stap 8) zicht geeft — precies de volgorde die de weger voorschrijft: schrijf pas een cursus als er mensen zijn die erom vragen.
